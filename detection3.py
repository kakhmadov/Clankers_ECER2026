...
def detect_and_draw(mask, color_name, box_color, frame):
    direction = "N"
    ...
    for cnt in contours:
        ...
        cv2.putText(frame, color_name, (x, y - 8),
...
def get_direction():
    ...
    detect_and_draw(mask_blue, "Blau", (255, 0, 0), frame)
    direction_green = detect_and_draw(mask_green, "Gruen", (0, 255, 0), frame)
    detect_and_draw(mask_red, "Rot", (0, 0, 255), frame)

    return direction_green